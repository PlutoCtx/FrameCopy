...
class Application_ui(Frame):
    ...
    def __init__(self, master=None):
        Frame.__init__(self, master)
        self.master.title('HX1 HXIIB2 V1.0')
        self.master.geometry('462x481')
        self.createWidgets()
...
#         # self.Command1 = Button(self.top, text='CRC', command=self.click_action, style='Command1.TButton')
#         # self.Command1.place(relx=0.485, rely=0., relwidth=0.123, relheight=0.052)
#         #
#         # self.style.configure('Command1.TButton', background='#FFFFE1', font=('宋体', 9))
#         # self.Command1 = Button(self.top, text='帮助[H]', command=self.click_action, style='Command1.TButton')
#         # self.Command1.place(relx=0.606, rely=0., relwidth=0.123, relheight=0.052)
#         #
#         # self.style.configure('Command1.TButton', background='#FFFFE1', font=('宋体', 9))
#         # self.Command1 = Button(self.top, text='语言[L]', command=self.click_action, style='Command1.TButton')
#         # self.Command1.place(relx=0.364, rely=0., relwidth=0.123, relheight=0.052)
#         #
#         # self.style.configure('Command1.TButton', background='#FFFFE1', font=('宋体', 9))
#         # self.Command1 = Button(self.top, text='升级[U]', command=self.click_action, style='Command1.TButton')
#         # self.Command1.place(relx=0.242, rely=0., relwidth=0.123, relheight=0.052)
#         #
#         # self.style.configure('Command1.TButton', background='#FFFFE1', font=('宋体', 9))
#         # self.Command1 = Button(self.top, text='操作[O]', command=self.click_action, style='Command1.TButton')
#         # self.Command1.place(relx=0.121, rely=0., relwidth=0.123, relheight=0.052)
#         #
#         # self.style.configure('Command1.TButton', background='#FFFFE1', font=('宋体', 9))
#         # self.Command1 = Button(self.top, text='文件[F]', command=self.click_action, style='Command1.TButton')
